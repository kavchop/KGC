...
swap = False                 #swap colums of raw triple files to bring to format 'subject predicate object', if not already in this format
...
valid_size = 10000          #to speed up validation validate on a randomly drawn set of x from validation set
