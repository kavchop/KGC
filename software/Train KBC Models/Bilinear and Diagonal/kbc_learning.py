...
def kbc_learning(KBC_Class):
    ...
    KBC_Model = KBC_Class(params.dataset, params.swap, params.dim, params.margin, params.device, params.learning_rate, params.max_epoch, params.batch_size, params.test_size, params.result_log_cycle, diagonal=False, shuffle_data=params.shuffle_data, check_collision=params.check_collision, normalize_ent=params.normalize_ent)
