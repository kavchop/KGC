...
class Bilinear(KBC_Class):
    ...
    def __init__(self, dataset, swap, dim, margin, device, learning_rate, max_epoch, batch_size, test_size, result_log_cycle, diagonal = False,  shuffle_data=True, check_collision=True, normalize_ent=True):
	...
	if diagonal: 
		...
		model_name = 'Bilinear'
        KBC_Class. __init__(self, dataset, swap, model_name, dim, margin, device, learning_rate, max_epoch, batch_size, test_size, result_log_cycle, shuffle_data=True, check_collision=True, normalize_ent=True)
