...
dim_ent = 20                    #dimension of embedding space of entities and relations
dim_rel = 30
...
result_log_cycle = 20        #run validation and log results after every x epochs
embedding_log_cycle = 20     #save embedding to disk after every x epochs
