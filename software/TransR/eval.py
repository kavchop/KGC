...
def run_evaluation(triples_set, test_matrix, ent_array_map, rel_array_map, Mr_map,
                   score_func, 
    ...
    for i in range(len(test_matrix)):
        a_h = {}
        a_t = {}
        tail = np.dot(Mr_map[test_matrix[i,1]], ent_array_map[test_matrix[i,2]])    
        head = np.dot(Mr_map[test_matrix[i,1]], ent_array_map[test_matrix[i,0]])    
