...
dim = 100                    #dimension of embedding space of entities and relations
...
learning_rate = 0.001         #for Adagrad optimizer
...
valid_size = 12000           #to speed up validation validate on a randomly drawn set of x from validation set
